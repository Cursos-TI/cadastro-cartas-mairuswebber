...
int main() {
    ...
    */
    ...
    printf(" =================== \n Carta Vencedora: \n -------------------\n\n");
    printf(" Carta 1 - %s: Superpoder: %lu\n", cidade1, superpoder1);
    printf(" Carta 2 - %s: Superpoder: %lu\n", cidade2, superpoder2);
    if ( superpoder1 > superpoder2 ) {
        printf("A carta 1, %s, com o superpoder %lu é a grande vencedora!\n\n", cidade1, superpoder1);
    } else {
        printf("A carta 2, %s, com o superpoder %lu é a grande vencedora!\n\n", cidade2, superpoder2);
    }
